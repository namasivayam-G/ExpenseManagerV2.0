 ...
 * 
 * import javax.servlet.Filter; import javax.servlet.http.HttpServletResponse;
 * 
 ...
 * 
 * @EnableWebSecurity //This annotation tells that this class contains
 * configuration for security public class SecurityTokenConfiguration extends
 * WebSecurityConfigurerAdapter{
 * 
 * @Autowired private jwtConfig jwtConf;
 * 
 ...
 * error)->response.sendError(HttpServletResponse.SC_UNAUTHORIZED)) .and()
